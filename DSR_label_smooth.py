...
def save_network(model,optimizer, epoch, loss):
    save_path = '../model_ckpts/label_smooth/epoch_{} loss_{}'.format(epoch, loss)+'.pth'
...
#https://github.com/CoinCheung/pytorch-loss/blob/master/label_smooth.py#L38
class LabelSmoothSoftLoss(nn.Module):
    '''
    This is the autograd version, you can also try the LabelSmoothSoftmaxCEV2 that uses derived gradients
    '''

    def __init__(self, lb_smooth=0.1, reduction='mean', ignore_index=-100):
        super(LabelSmoothSoftLoss, self).__init__()
